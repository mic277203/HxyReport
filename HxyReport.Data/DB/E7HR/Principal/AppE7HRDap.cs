...
{
    public partial class AppE7HRBaseDap : IDisposable
    {
        private IDbConnection _connection;
        private IDbTransaction _transaction;

        protected AppE7HRBaseDap()
        {
            Connection = new SqlConnection(ConfigurationManager.ConnectionStrings["E7HR"].ConnectionString);
        }
