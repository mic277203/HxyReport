...
{
    public partial class AppOfficeBaseDap : IDisposable
    {
        private IDbConnection _connection;
        private IDbTransaction _transaction;

        protected AppOfficeBaseDap()
        {
            Connection = new SqlConnection(ConfigurationManager.ConnectionStrings["AppOffice"].ConnectionString);
        }
